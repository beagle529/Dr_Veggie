...
<head>
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const timeLimit = {{ time_limit }}; // 從後端傳遞的時間限制
...
def challenge():
    ...
    # 計算每關的答題時間
    base_time = 30  # 第一關時間
    time_limit = max(10, base_time - (level - 1) * 2)  # 每關減少 2 秒，最低 10 秒
